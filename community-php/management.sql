...
Date: 2020-03-22 23:20:39
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for ma_admin_action
-- ----------------------------
DROP TABLE IF EXISTS `ma_admin_action`;
CREATE TABLE `ma_admin_action` (
  `action_id` tinyint(3) NOT NULL AUTO_INCREMENT,
  `parent_id` tinyint(3) NOT NULL DEFAULT '0' COMMENT '对应action_id方法名对应的类名id',
  `action_code` varchar(50) NOT NULL DEFAULT '' COMMENT 'parent_id为0是类名其他方法名',
  `action_name` varchar(20) NOT NULL COMMENT 'action名字',
  PRIMARY KEY (`action_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='访问权限列表';

-- ----------------------------
-- Records of ma_admin_action
-- ----------------------------
INSERT INTO `ma_admin_action` VALUES ('1', '0', '', '系统用户');
INSERT INTO `ma_admin_action` VALUES ('2', '1', 'AdminUser/user', '管理员');
INSERT INTO `ma_admin_action` VALUES ('3', '1', 'AdminRole/role', '角色管理');
INSERT INTO `ma_admin_action` VALUES ('4', '0', '', '协议管理');
INSERT INTO `ma_admin_action` VALUES ('5', '4', 'Set/setUserAgree', '用户协议');
INSERT INTO `ma_admin_action` VALUES ('6', '0', '', '设置');
INSERT INTO `ma_admin_action` VALUES ('7', '6', 'Set/setPassword', '修改密码');

-- ----------------------------
-- Table structure for ma_admin_role
-- ----------------------------
...
-- ----------------------------
-- Records of ma_admin_role
-- ----------------------------
INSERT INTO `ma_admin_role` VALUES ('1', 'admin', '1,2,3,4,5,6,7', '超级管理员');
...
-- ----------------------------
INSERT INTO `ma_admin_user` VALUES ('1', 'root', '63a9f0ea7bb98050796b649e85481845', '1', '1', '2020-03-22 23:17:08', '2020-03-22 23:17:08');

-- ----------------------------
-- Table structure for ma_set
-- ----------------------------
DROP TABLE IF EXISTS `ma_set`;
CREATE TABLE `ma_set` (
